...
namespace Keuken_Kok
{
    public partial class KeukenForm : Form
    {
        ...
        {
            DAL.Keuken_DAL db = new DAL.Keuken_DAL();
        ...
        private void KeukenForm_Load(object sender, EventArgs e)
        {
        ...
        private void BTN_GereedMelden_Click_1(object sender, EventArgs e)
        {
            foreach (ListViewItem item in LV_Orders.Items)
            {
                if (item.Selected)
                {
                    ...
                    Logica.Keuken_Logica.Instance.meldGereed(bestellingItem);
                }
            }
